...
/**
 * REST controller for managing items in the Lahorde API.
...
public class ItemController {
	 ...
	 * Creates a new item.
	 *
	 * @param dto the ItemDTO object containing the details of the item to create.
	 ...
	 * @param dto the ItemDTO object containing the new details for the item.
