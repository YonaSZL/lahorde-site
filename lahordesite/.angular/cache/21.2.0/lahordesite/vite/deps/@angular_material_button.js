...
import { BidiModule } from './chunk-ENYIPHQ4.js';
...
var MatRippleLoader = class _MatRippleLoader {
	...
	_createRipple(host) {
		...
		const enterDuration = this._animationsDisabled
			? 0
			: (globalOptions?.animation?.enterDuration ??
				defaultRippleAnimationConfig.enterDuration);
		...
		const target = {
			rippleDisabled:
				...
				host.hasAttribute(matRippleDisabled),
			rippleConfig: {
					...
					args: [
						{
							host: {
								...
								'[class.mat-mdc-button-disabled-interactive]':
									'disabledInteractive',
...
var MatFabButton = class _MatFabButton extends MatButtonBase {
	...
	static ɵcmp = ɵɵdefineComponent({
		...
		hostBindings: function MatFabButton_HostBindings(rf, ctx) {
			if (rf & 2) {
				ɵɵclassProp('mdc-fab--extended', ctx.extended)(
