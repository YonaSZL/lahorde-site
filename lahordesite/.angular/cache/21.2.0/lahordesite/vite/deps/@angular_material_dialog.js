...
} from './chunk-YDJYJGLI.js';
import { _CdkPrivateStyleLoader } from './chunk-FVUJPUH7.js';
import { BidiModule, Directionality } from './chunk-ENYIPHQ4.js';
import './chunk-GT72NYTI.js';
import { Location } from './chunk-QKWJTKON.js';
...
function isDataSource(value) {
	return (
		value && typeof value.connect === 'function' && !(value instanceof ConnectableObservable)
	);
}
...
var BlockScrollStrategy = class {
	...
	_canBeEnabled() {
		...
		return (
			rootElement.scrollHeight > viewport.height || rootElement.scrollWidth > viewport.width
		);
	}
};
	...
	enable() {
		...
		if (this._config && this._config.threshold && this._config.threshold > 1) {
			...
			this._scrollSubscription = stream.subscribe(() => {
				...
				if (
					Math.abs(scrollPosition - this._initialScrollPosition) > this._config.threshold
				) {
					this._detach();
				} else {
	...
	static ɵfac = /* @__PURE__ */ (() => {
		...
		return function OverlayKeyboardDispatcher_Factory(__ngFactoryType__) {
			return (
				...
				(ɵOverlayKeyboardDispatcher_BaseFactory = ɵɵgetInheritedFactory(
...
var OverlayRef = class {
	...
	_attachBackdrop() {
		...
		this._backdropRef?.dispose();
		this._backdropRef = new BackdropRef(
			this._document,
			this._renderer,
			this._ngZone,
			(event) => {
...
var FlexibleConnectedPositionStrategy = class {
	...
	_pushOverlayOnScreen(start, rawOverlayRect, scrollPosition) {
		...
		if (overlay.height <= viewport.height) {
			...
			pushY =
				start.y < this._getViewportMarginTop()
	...
	_calculateBoundingBoxRect(origin, position) {
		...
		if (position.overlayY === 'top') {
			...
			bottom =
				viewport.height -
				origin.y +
				this._getViewportMarginTop() +
				this._getViewportMarginBottom();
		...
		if (isBoundedByLeftViewportEdge) {
			right =
				viewport.width -
				origin.x +
				this._getViewportMarginStart() +
				this._getViewportMarginEnd();
...
var CdkConnectedOverlay = class _CdkConnectedOverlay {
	...
	_assignConfig(config) {
		...
		this.transformOriginSelector =
			config.transformOriginSelector ?? this.transformOriginSelector;
	...
	_canClose(result) {
		...
		return (
			...
			(!config.closePredicate ||
				config.closePredicate(result, config, this.componentInstance))
		);
	}
};
...
var MatDialogContainer = class _MatDialogContainer extends CdkDialogContainer {
	...
	static ɵfac = /* @__PURE__ */ (() => {
		...
		return function MatDialogContainer_Factory(__ngFactoryType__) {
			return (
				ɵMatDialogContainer_BaseFactory ||
				(ɵMatDialogContainer_BaseFactory = ɵɵgetInheritedFactory(_MatDialogContainer))
			)(__ngFactoryType__ || _MatDialogContainer);
		};
	})();
	static ɵcmp = ɵɵdefineComponent({
		...
		hostBindings: function MatDialogContainer_HostBindings(rf, ctx) {
			if (rf & 2) {
				...
				ɵɵattribute('aria-modal', ctx._config.ariaModal)('role', ctx._config.role)(
					'aria-labelledby',
...
var MatDialogTitle = class _MatDialogTitle extends MatDialogLayoutSection {
	...
	static ɵfac = /* @__PURE__ */ (() => {
		...
		return function MatDialogTitle_Factory(__ngFactoryType__) {
			...
			)(__ngFactoryType__ || _MatDialogTitle);
		};
	})();
	static ɵdir = ɵɵdefineDirective({
...
var MatDialogActions = class _MatDialogActions extends MatDialogLayoutSection {
	...
	static ɵfac = /* @__PURE__ */ (() => {
		...
		return function MatDialogActions_Factory(__ngFactoryType__) {
			...
			)(__ngFactoryType__ || _MatDialogActions);
		};
	})();
	static ɵdir = ɵɵdefineDirective({
