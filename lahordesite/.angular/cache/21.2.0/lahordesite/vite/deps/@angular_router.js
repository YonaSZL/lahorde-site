import { Title } from './chunk-GT72NYTI.js';
import {
	...
	PlatformNavigation,
	ViewportScroller
} from './chunk-QKWJTKON.js';
import './chunk-4HBJTP5X.js';
import { LOCATION_INITIALIZED, PlatformLocation } from './chunk-KHOL2P7N.js';
import {
...
function isMatrixParams(command) {
	return (
		typeof command === 'object' && command != null && !command.outlets && !command.segmentPath
	);
}
...
(function (NavigationCancellationCode2) {
	...
	NavigationCancellationCode2[(NavigationCancellationCode2['NoDataFromResolver'] = 2)] =
		'NoDataFromResolver';
	NavigationCancellationCode2[(NavigationCancellationCode2['GuardRejected'] = 3)] =
		'GuardRejected';
	...
	processRoutes(injector, routes) {
		...
		for (const route of routes) {
			...
			if (route.children || route._loadedRoutes) {
				res.push(
					this.processRoutes(injectorForChildren, route.children ?? route._loadedRoutes)
				);
			}
		}
