import { PlatformLocation } from './chunk-KHOL2P7N.js';
import {
	ApplicationRef,
	Attribute,
	ChangeDetectorRef,
	...
	ngOnChanges(changes) {
		if (this._needToReCreateComponentInstance(changes)) {
			...
			if (this.ngComponentOutlet) {
				const injector =
					this.ngComponentOutletInjector || this._viewContainerRef.parentInjector;
...
var DatePipe = class _DatePipe {
	...
	transform(value, format, timezone, locale) {
		...
		try {
			...
			const _timezone =
				timezone ?? this.defaultOptions?.timezone ?? this.defaultTimezone ?? void 0;
...
//# sourceMappingURL=chunk-QKWJTKON.js.map
